...
//	 * @param inverse
//	 *            whether to calculate the FFT or the inverse FFT2.
//	 */
...
//		}
//
//		// Now real and imag are in the right order for the FFT2.
//		// FFT:
...
//			FFT2.realTransform(result3, false);
...
//
//			// And backwards:
//			FFT2.transform(ar, ai, true);
//			FFT2.transform(result2, true);
//			double[] inverse2 = new double[N];
//			for (int j = 0; j < N; j++) {
//				inverse2[j] = result2[2 * j];
//			}
//			FFT2.realTransform(result3, true);
...
//					FFT2.transform(re, im, false);
//					FFT2.transform(re, im, true);
//				}
//				long mid = System.currentTimeMillis();
//				for (int j = 0; j < 5000; j++) {
//					FFT2.realTransform(re, false);
//					FFT2.realTransform(re, true);
//				}
